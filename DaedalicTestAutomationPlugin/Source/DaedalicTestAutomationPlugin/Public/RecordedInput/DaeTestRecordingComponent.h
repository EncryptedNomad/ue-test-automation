...
#include "DaeTestRecordedInputBaseComponent.h"
#include <CoreMinimal.h>
#include <Serialization/BufferArchive.h>
#include "DaeTestRecordingComponent.generated.h"
...
UCLASS()
class DAEDALICTESTAUTOMATIONPLUGIN_API UDaeTestRecordingComponent
    : public UDaeTestRecordedInputBaseComponent
{
    GENERATED_BODY()
